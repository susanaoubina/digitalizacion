...
## 🌐 Enlaces para el aula virtual

### Opción recomendada — GitHub Pages

Enlaces limpios y estables. Para activarlos una sola vez: *Settings → Pages → Source: «Deploy from a branch» → Branch: `main` / `/ (root)` → Save*.
...
Los archivos son HTML autocontenidos (sin dependencias externas): funcionan **sin conexión** abriéndolos directamente en cualquier navegador moderno, o en línea a través de los enlaces anteriores. Pensados para ordenadores del aula.

---

## ✍️ Autoría

Creado por **Susana Oubiña Falcón** y **Claude (Opus 4.8)**.
Material educativo para la materia de Digitalización · 4.º ESO.
